...
class Recognize_Face:
    def __init__(self, DEPTH_SCALE, LANDMARKS_MODEL, ROCOGNITION_RESNET_MODEL, FACES_FEATURES_CSV_FILE, FACES_FOLDER):
    ...
    def recognize_from_2_frame(self, frame_2d, frame_3d, DISTANCE_THRESHOLD, is_ir):
        IS_PEOPLE = False
        IS_VALIDATE = False
        IS_RECOGNIZE = False
